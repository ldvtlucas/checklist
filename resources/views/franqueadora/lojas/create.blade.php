                        ...
                        <div class="form-group mt-2">
                            ...
                            <div class="d-flex justify-content-center mt-2">
                                ...
                                <div class="ml-2">
                                    ...
                                    <br>
                                    <input type="date" name="data_contrato" class="form-control {{ $errors->has('data_contrato') ? 'is-invalid' : ''}}" value="{{isset($loja->data_contrato) ? $loja->data_contrato : old('data_contrato')}}">
                                </div>
                            </div>
